...
<div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-sm border border-gray-200">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Registrar Nuevo Pedido</h1>
    ...
    <form action="{{ route('pedidos.store') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            >
                ...
                <option value="PENDIENTE" {{ old('estado_pedido') == 'PENDIENTE' ? 'selected' : '' }}>Pendiente</option>
                <option value="EN PROCESO" {{ old('estado_pedido') == 'EN PROCESO' ? 'selected' : '' }}>En proceso</option>
