...
<div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="space-y-4">
        <div class="flex justify-between border-b pb-2">
            ...
            <span class="text-gray-900">{{ $categoria->id_categorias }}</span>
        </div>
        <div class="flex justify-between border-b pb-2">
            <strong class="text-gray-700">Nombre:</strong>
            <span class="text-gray-900">{{ $categoria->nombre_categoria }}</span>
        </div>
        <div class="flex justify-between border-b pb-2">
    ...
    @if ($categoria->productos->isNotEmpty())
        <div class="mt-8">
            <h2 class="text-lg font-semibold text-gray-800 mb-3">Productos en esta categoría</h2>
